...
:::: {.col .fragment}
[{{< fa brands markdown size=2x >}}]{.blue}
...
::: {.col width="55%"}
[{{< fa file-word size=2x >}}]{.red}

[**Word**]{.red} (`word/document.xml`)
...
<!--
  ...
  ICONS ARE FONT AWESOME WEBFONT GLYPHS, not paths: `Font Awesome 6 Free` at
  weight 900 for the solid file icons (\f1c1 pdf, \f1c2 word) and
  `Font Awesome 6 Brands` at 400 for html5 (\f13b) and markdown (\f60f). The
  font is already on the page because the three character-count slides use the
  `fa` shortcode; if those ever go, this figure turns to tofu, which is why
  every icon also carries a text label beside it.
  ...
  COLORS are the cost escalation from the character slides, NOT the
  content/format chips: teal Quarto, amber PDF, red HTML, red Word. Same order,
  same colors, so this slide and fig-tokens agree. The entanglement figure's
  yellow/teal vocabulary is deliberately absent — this slide is about what was
  measured, not about what is fused to what.
...
<svg viewBox="0 75 1085 505" width="100%" style="max-height:80vh;"
  ...
  <g transform="translate(0 330)">
    ...
    <text x="468" y="0" font-size="46" text-anchor="middle"
          ...
          font-family="'Font Awesome 6 Free'" font-weight="900">&#xf1c2;</text>
    <text x="500" y="0" font-size="26" dominant-baseline="central"
          fill="#d1495b" font-family="SFMono-Regular, Menlo, monospace">.docx</text>
  </g>
  ...
  <g class="fragment" data-fragment-index="1">
    ...
    <g transform="translate(0 500)">
      ...
      <!-- The one .qmd. Teal, because on the character slides teal is Quarto. -->
      <text x="482" y="0" font-size="46" text-anchor="middle"
            dominant-baseline="central" fill="#00798c"
            font-family="'Font Awesome 6 Brands'" font-weight="400">&#xf60f;</text>
      <text x="526" y="0" font-size="26" dominant-baseline="central"
            fill="#00798c" font-family="SFMono-Regular, Menlo, monospace">.qmd</text>
