...
```{=html}
<svg viewBox="0 75 1085 505" width="100%" style="max-height:80vh;"
     xmlns="http://www.w3.org/2000/svg"
     font-family="'Fira Sans Condensed', Tahoma, sans-serif">
  ...
  <g class="fragment" data-fragment-index="1">
    ...
    <g transform="translate(0 500)">
      ...
      <path d="M 682 0 L 682 -38 Q 682 -50 694 -50 L 762 -50" fill="none"
      ...
      <text x="800" y="-50" font-size="46" text-anchor="middle"
            dominant-baseline="central" fill="#A77400"
            font-family="'Font Awesome 6 Free'" font-weight="900">&#xf1c1;</text>
      <text x="834" y="-50" font-size="26" dominant-baseline="central"
            fill="#A77400" font-family="SFMono-Regular, Menlo, monospace">.pdf</text>
...
# This map has no automated failure mode
...
<span style="color:#8d96a3;">Quitting from index.qmd:12-30 [africa-map]</span>
<span style="color:#d1495b; font-weight:bold;">Error:</span>
<span style="color:#d1495b;">! all(funding$name %in% africa$name) is not TRUE</span>
Execution halted
</pre>
...
<pre class="specimen diffcard">
  ...
  Sales of **electric vehicles** grew 20% in 2025,
<span style="color:#8d96a3;">- reaching over _20 million_ sales globally.</span>
<span style="background:#fbe9eb; color:#d1495b; font-weight:700;">+ reaching nearly _20 million_ sales globally.</span>
</pre>
...
## HTML is good, but it can't tell you if it's broken
