...
# [JavaScript from [{{< fa brands r-project >}}]{.blue} or [{{< fa brands python >}}]{.yellow} packages]{.center}
...
## [Widgets that talk to each other:<br>`crosstalk` + `plotly`]{.center}
...
# [Widgets that talk to each other: `ojs`]{.center}
