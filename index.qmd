...
## That map rendered fine

::: {.col}
[**Ask for the map**]{.red}

The shapes were **drawn**.

A wrong shape looks exactly like a right one. It renders. It ships. Nobody
catches it.
:::

::: {.col}
[**Ask for the source**]{.blue}

The shapes are **joined** — country names to a shapefile.

A wrong name doesn't render. It **fails**.
:::

[The artifact had no failure mode. That's the whole problem.]{.font120}
...
# [vehicletrends.us]{.font150}

[**169,552,665** listings · 100,000+ dealerships · 2018–2025]{.font120}

[Nobody typed that number. The page computes it at render.]{.font120 .orange}
