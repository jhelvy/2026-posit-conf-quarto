...
<!-- The mark, not a decoration: the talk's subject gets to sit above its own
     title. The `quarto` shortcode always paints the brand #74aadb, which is why
     the card is the deck's navy rather than the inverse black — that blue has
     nothing to sit against on black. `bg-color` + `inverse` is exactly the
     pairing the guarded card rule in lexis.scss exists for: light text, chosen
     ground. -->
{{< quarto size=3x >}}
...
### Failures are loud and specific
:::

::: {.col}
## [**By human**]{.darkgreen}

### Plain text means the agent's edit is a **diff**
:::
