...
<!--
  ...
  slide 1's ("170 77 900 553") and so is the row's y (175): that is the whole
...
<svg viewBox="170 77 900 553" width="100%"
     style="max-height:85vh; position:relative; top:50px;"
     xmlns="http://www.w3.org/2000/svg"
     font-family="'Fira Sans Condensed', Tahoma, sans-serif">
