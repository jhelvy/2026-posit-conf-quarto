...
<!--
  ...
  (bands / dots / blocks) and not merely in band heights.
...
<svg viewBox="0 77 1240 553" width="100%" style="max-height:80vh;"
  ...
  <defs>
    ...
    <!-- Byte-identical to #doc on the previous slide, page and fold and `.pdf`
         label and all. If you edit one, edit both — the whole point is that the
  ...
  <!-- The artifact. Byte-identical to run 1 on slide 1, same page, same 1:1
  ...
  <g class="fragment" data-fragment-index="2">
    <path d="M 255 211 L 255 265 Q 255 277 267 277 L 678 277 Q 690 277 690 265 L 690 245"
          fill="none" stroke="#852f88" stroke-width="2.5"
          marker-end="url(#ahEdit2)"/>
    <text x="472" y="303" font-size="20" fill="#852f88"
...
Click 2. And because it has places, I can reach in myself. Not re-prompt — edit.
...
# [[Ask for the [source (.qmd)]{.yellow},<br>not the [artifact (.pdf)]{.red}]{.font150}]{.center}
...
# [Ask for the [source (.qmd)]{.yellow},<br>not the [artifact (.pdf)]{.red}]{.center}

::: {.col width="15%"}
:::

::: {.col}
## ✅ Disentangles content and format
:::
...
## One paragraph. Three sources.

```{=html}
<div style="max-width: 46%; margin: 0 auto 0.6em auto; padding: 0.7em 1.4em;
            background: #FFFFFF; border: 2px solid #2e4057; border-radius: 6px;
            font-family: Georgia, 'Times New Roman', serif; color: #2e4057;
            text-align: left;">
  <div style="font-size: 0.95em; font-weight: 700; margin-bottom: 0.25em;">EV Sales</div>
  <div style="font-size: 0.72em; line-height: 1.35;">Sales of <strong>electric
  vehicles</strong> grew <em>42%</em> in 2025.</div>
</div>
```
...
\begin{document}
\section*{EV Sales}
Sales of \textbf{electric vehicles}
grew \emph{42\%} in 2025.
\end{document}
```
:::

[**207** characters]{.red .font140}
::::
...
<body>
<h2>EV Sales</h2>
<p>Sales of <strong>electric vehicles</strong>
grew <em>42%</em> in 2025.</p>
</body>
</html>
```
:::

[**336** characters]{.red .font140}
::::
...
<w:document xmlns:w="http://schemas.openxmlformats.org/
  ...
  <w:body>
    ...
    <w:p>
      ...
      <w:r><w:t xml:space="preserve"> grew </w:t></w:r>
      <w:r><w:rPr><w:i/></w:rPr><w:t>42%</w:t></w:r>
      <w:r><w:t xml:space="preserve"> in 2025.</w:t></w:r>
    </w:p>
  </w:body>
</w:document>
```
